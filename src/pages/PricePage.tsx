...
const priceCategories = [
  {
    ...
    icon: "Wind",
    items: [
      { name: "Установка настенного кондиционера до 2,5 кВт (07)", price: "от 4 000 ₽" },
      { name: "Установка настенного кондиционера до 3,5 кВт (09–12)", price: "от 5 000 ₽" },
      { name: "Установка настенного кондиционера до 5 кВт (18)", price: "от 6 000 ₽" },
      { name: "Установка настенного кондиционера до 7 кВт (24)", price: "от 7 000 ₽" },
      { name: "Прокладка трассы (за 1 м.п.)", price: "от 500 ₽" },
  ...
  },
  {
    ...
    icon: "Building2",
    items: [
      { name: "Мульти-сплит на 2 внутренних блока", price: "от 12 000 ₽" },
      { name: "Мульти-сплит на 3 внутренних блока", price: "от 16 000 ₽" },
      { name: "Мульти-сплит на 4 внутренних блока", price: "от 20 000 ₽" },

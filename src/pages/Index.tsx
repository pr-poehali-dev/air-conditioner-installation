...
const guarantees = [
  {
    ...
    desc: "На монтаж кондиционеров и все выполненные работы. При поломке по нашей вине — устраняем бесплатно.",
  },
  {
    icon: "Award",
    title: "Сертифицированные монтажники",
    desc: "Специалисты с допуском к работе с фреоном, аттестациями Daikin, Mitsubishi, LG и опытом от 5 лет.",
  },
  {
    icon: "ClipboardCheck",
  ...
  },
  {
    ...
    desc: "Установка кондиционера — в день обращения или в удобное для вас время. Никаких переносов без предупреждения.",
  },
];

...
const services = [
  {
    icon: "Wifi",
    title: "Установка интернета и Wi-Fi",
    desc: "Прокладка кабеля, настройка роутеров и точек доступа. Уверенный сигнал в каждой комнате.",
    time: "1–2 дня",
    color: "#00d4ff",
  },
  {
    ...
    desc: "Монтаж IP-камер, видеорегистраторов, удалённый доступ через приложение на смартфоне.",
    time: "1–3 дня",
    color: "#0099ff",
  },
  {
    ...
    desc: "Установка датчиков движения, магнитных контактов, сирен и кнопок экстренного вызова.",
    time: "2–4 дня",
    color: "#00ccff",
  },
  {
    icon: "Zap",
    title: "Умный дом",
    desc: "Автоматизация освещения, климата, штор и бытовой техники. Управление голосом и приложением.",
    time: "3–7 дней",
    color: "#00d4ff",
  },
  {
    icon: "Phone",
    title: "Структурированная кабельная сеть",
    desc: "Профессиональная разводка кабелей, кроссировка, маркировка. Под ключ в любом масштабе.",
    time: "2–5 дней",
    color: "#0099ff",
  },
  {
    icon: "Monitor",
    title: "Интерактивные панели и AV-системы",
    desc: "Монтаж телевизоров, проекторов, звуковых систем и переговорных залов.",
    time: "1–3 дня",
    color: "#00ccff",
  },
];
